...
%--------------------------------------------------------------------------
    ...
    methods(Access = ?GUI)
        ...
        function obj = module_test(GUI)
            ...
            obj.control.showButton  = newPopmenu3(obj.control.axesToolBar,[453 1 105 25,0 1 1 0],[{obj.GUI.icons.showPF,obj.GUI.icons.showPS,[],obj.GUI.icons.showTPF,[]},cell(1,length(obj.GUI.metList{1,2}))],...
                                                  [{'Pareto Front','Pareto Set','','True PF',''},obj.GUI.metList{1,2}'],'callback',@obj.cb_showbutton);
            ...
            obj.control.metricList = newPopmenu2(panel,[10 455 120 20,0 0 0 1],[.1 .1 .1],false,['runtime';obj.GUI.metList{1,2}],'callback',@obj.cb_metricList);
